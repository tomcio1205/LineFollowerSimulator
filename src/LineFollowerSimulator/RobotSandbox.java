...
/**
 * The playground for the robot. Contains the robot and a line.
 * Runs its own thread that does discrete (step-by-step) simulation
...
//	guideline.append(new CubicCurve2D.Float(200, 100, 200, 200, 100, 100, 100, 200), false);
        //length 233.24
        guideline.append(new CubicCurve2D.Float(80, 100, 80, 100, 200, 300, 200, 300), false);
//	guideline.append(new CubicCurve2D.Float(100, 200, 100, 300, 300, 200, 400, 200), false);
        //length 223.60
	guideline.append(new CubicCurve2D.Float(200, 300, 200, 300, 400, 200, 400, 200), false);
//	guideline.append(new CubicCurve2D.Float(400, 200, 600, 200, 200, 0, 200, 100), false);
        //length 228.25
	guideline.append(new CubicCurve2D.Float(400, 200, 400, 200, 290, 0, 290, 0), false);
        // length 232.59
	guideline.append(new CubicCurve2D.Float(290, 0, 290, 0, 80, 100, 80, 100), false);
        // length = 917.7


	robot = new Robot(80,80,Math.PI/2,guideline);
